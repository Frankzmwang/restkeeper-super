...
public interface TableAreaFace {
     ...
     * @Description 区域列表
     */
    Page<TableAreaVo> findTableAreaVoPage(TableAreaVo tableAreaVo, int pageNum, int pageSize);
     ...
     * @Description 创建区域
     */
    TableAreaVo createTableArea(TableAreaVo tableAreaVo);
     ...
     * @Description 查找区域
     */
    TableAreaVo findTableAreaByTableAreaId(Long tableAreaId);

    /***
     * @description 查询区域下拉框
     * @return: List<TableAreaVo>
     */
    List<TableAreaVo> findTableAreaVoList();
}
