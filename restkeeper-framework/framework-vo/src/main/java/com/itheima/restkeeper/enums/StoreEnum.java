...
public enum StoreEnum implements IBasicEnum {
    SUCCEED("200","操作成功"),
    FAIL("1000","操作失败"),
    PAGE_FAIL("14005", "查询门店列表失败"),
    CREATE_FAIL("14007", "保存门店失败"),
    UPDATE_FAIL("14008", "修改门店失败"),
    DELETE_FAIL("14009", "修改门店失败"),
    SELECT_STORE_FAIL("14010", "查询门店失败"),
    SELECT_STORE_LIST_FAIL("14010", "查询门店list失败")
    ;
