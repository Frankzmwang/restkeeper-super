...
public enum CategoryEnum implements IBasicEnum {
    SUCCEED("200","操作成功"),
    FAIL("1000","操作失败"),
    PAGE_FAIL("15005", "查询分类列表失败"),
    CREATE_FAIL("15007", "保存分类失败"),
    UPDATE_FAIL("15008", "修改分类失败"),
    DELETE_FAIL("15009", "修改分类失败"),
    SELECT_CATEGORY_FAIL("15010", "查询分类失败"),
    SELECT_CATEGORY_LIST_FAIL("15010", "查询分类list失败")
    ;
